    ...
    render() {
        ...
        <div className="row justify-content-center">
            ...
            <ul className="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
              <li className="nav-item bg-color-green" role="presentation">
            ...
            <div className="tab-content">
              <div className={classNames("tab-pane", "fade", this.state.active === "login" ? "show active" : "")} id="pills-login" >
                <form onSubmit={this.onSubmitLogin}>
                  ...
                  <label className="form-label" htmlFor="loginName">Почта</label>
              ...
              <div className={classNames("tab-pane", "fade", this.state.active === "register" ? "show active" : "")} id="pills-register" >
                <form onSubmit={this.onSubmitRegister}>
                  ...
                  <div className="form-outline mb-4">
                  <label className="form-label" htmlFor="login">Почта</label>
                  ...
                  <button type="submit" className="btn btn-success btn-block mb-3">Зарегистрироваться</button>
                </form>
              </div>
            </div>
            </div>
